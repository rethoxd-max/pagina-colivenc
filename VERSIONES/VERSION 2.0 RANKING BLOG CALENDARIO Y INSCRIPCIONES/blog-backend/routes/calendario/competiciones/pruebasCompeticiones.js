...
router.get('/ids', async (req, res) => {
  try {
    ...
    const pruebas = await PruebaCompeticion.find({ _id: { $in: ids } })
      .populate('sector_id')  // Popula toda la información de sector, incluido nombre_sector
      .populate('categoria_id');  // Popula categoría
