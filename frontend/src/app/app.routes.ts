...
export const routes: Routes = [
    ...
    { path: 'formularioMarca', component: CreatePerformanceComponent, canActivate: [AuthGuard, adminGuard] },
    { path: 'edit-marca/:id', component: CreatePerformanceComponent, canActivate: [AuthGuard, adminGuard] },
    { path: 'formularioAtleta', component: CreateAtletaComponent, canActivate: [AuthGuard, adminGuard] },
    { path: 'formularioPrueba', component: CreatePruebaComponent, canActivate: [AuthGuard, adminGuard] },
